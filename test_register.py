...
from app.service import register_unregistered_missing_items_csvs, _load_csv_rows_from_path
...
with open(dummy_missing, "w", encoding="utf-8-sig") as f:
    writer = csv.writer(f)
    # Write at least one row to trigger MISSING_ITEM_UNRESOLVED
...
result = register_unregistered_missing_items_csvs(conn)
print("Result of register_unregistered_missing_items_csvs:")
import json
