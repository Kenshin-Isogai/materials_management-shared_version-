  ...
  return (
    <div className="space-y-6">
      ...
      <section className="panel p-4" ref={orderDetailsRef}>
        <div className="mb-3 flex items-center justify-between gap-3">
          <h2 className="font-display text-lg font-semibold">Purchase Order Line Details</h2>
          {selectedOrder && (
            <button type="button" className="button-subtle" onClick={() => setSelectedOrderId(null)}>
              Clear
            </button>
        ...
        {!selectedOrder && (
          <p className="text-sm text-slate-500">
            Select <strong>Line Details</strong> from any row to review the selected purchase-order line, item metadata, and
        ...
        {selectedOrder && (
          <div className="space-y-3 text-sm">
            <div className="rounded-lg border border-slate-200 bg-slate-50 p-3">
              <p>
                <strong>Purchase order line:</strong> #{selectedOrder.order_id}
              </p>
              <p>
