  ...
  return (
    <div className="space-y-6">
      ...
      <section className="panel p-4">
        ...
        <p className="mt-1 text-sm text-slate-600">
          Use this only for missing-item registration CSVs generated by the Orders or missing-items workflow. The server processes the uploaded files directly and runs the batch registration flow without requiring server-folder access.
        </p>
